...
<section class="fpd-sidebar fpd-clearfix sidebar">
	...
	<div class="fpd-navigation">
		<a class="fpd-nav-item" data-target=".fpd-products" title="<?php echo $products_menu; ?>"><i class="fa fa-book"></i><span>Products</span></a>
		<a class="fpd-nav-item" data-target=".fpd-designs" title="<?php echo $designs_menu; ?>"><i class="fa fa-folder-open"></i><span>Designs</span></a>
